...
```javascript
constants = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int8@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-int8@umd/bundle.js"></script>
```
